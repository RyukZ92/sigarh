...
$condicion = "ra.dni_estudiante = '" . $_SESSION["dni_estudiante"] . "' AND nota > 9 AND anio_escolar='1'";
$orden = "codigo ASC";
...
$datos = array("codigo_asignatura", "periodo_academico", "tipo", "fecha", "i.nombre AS institucion", 
			   "a.nombre AS asignatura", "s.nombre AS semestre", "s.nombre AS semestre", "id_institucion", "nota");
$condicion = "ra.dni_estudiante = '" . $_SESSION["dni_estudiante"] . "' AND nota > 9 AND anio_escolar='2'";
$orden = "codigo ASC";
...
$datos = array("codigo_asignatura", "periodo_academico", "tipo", "fecha", "i.nombre AS institucion", 
			   "a.nombre AS asignatura", "s.nombre AS semestre", "s.nombre AS semestre", "id_institucion", "nota");
$condicion = "ra.dni_estudiante = '" . $_SESSION["dni_estudiante"] . "' AND nota > 9 AND anio_escolar='3'";
$orden = "codigo ASC";
...
$datos = array("codigo_asignatura", "periodo_academico", "tipo", "fecha", "i.nombre AS institucion", 
			   "a.nombre AS asignatura", "s.nombre AS semestre", "s.nombre AS semestre", "id_institucion", "nota");
$condicion = "ra.dni_estudiante = '" . $_SESSION["dni_estudiante"] . "' AND nota > 9 AND anio_escolar='4'";
$orden = "codigo ASC";
...
$datos = array("codigo_asignatura", "periodo_academico", "tipo", "fecha", "i.nombre AS institucion", 
			   "a.nombre AS asignatura", "s.nombre AS semestre", "s.nombre AS semestre", "id_institucion", "nota");
$condicion = "ra.dni_estudiante = '" . $_SESSION["dni_estudiante"] . "' AND nota > 9 AND anio_escolar='5'";
$orden = "codigo ASC";
$_semestre11 = $objCrudGenerica->consultar($tabla, $datos, $condicion, $orden);

$condicion = "anio_escolar = '5'";
...
$datos = array("codigo_asignatura", "periodo_academico", "tipo", "fecha", "i.nombre AS institucion", 
			   "a.nombre AS asignatura", "s.nombre AS semestre", "s.nombre AS semestre", "id_institucion", "nota");
$condicion = "ra.dni_estudiante = '" . $_SESSION["dni_estudiante"] . "' AND nota > 9 AND anio_escolar='6'";
$orden = "codigo ASC";
$_semestre12 = $objCrudGenerica->consultar($tabla, $datos, $condicion, $orden);

$condicion = "anio_escolar = '6'";
...
require "views/reporte/generarCertificacionDeNotasGeneralView.php";
