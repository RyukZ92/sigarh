...
if ($_POST['confirmar']) {
    ...
    if ($result) {
        ...
        $datos = array("accion"    => "Restauró al Secretariado: <b>" . $_secretariado[0]["tipo_dni"] . "-" .$_POST["dni_secretariado"] . "</b>",
...
require "views/secretariado/restaurarPersonalSecretariadoView.phtml";
